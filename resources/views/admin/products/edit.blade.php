                ...
                <div class="form-group">
                    ...
                    <select name="category[]" multiple class="form-control" id='categories'>
                        @foreach(App\models\Category::all() as $cate)
                            ...
                            <option value="{{$cate->id}}" {{ in_array($cate->id,$product->category->pluck('id')->toArray()) ? 'selected' : '' }}>{{ $cate->name  }}</option>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <select name="attributes[{{ $loop->index }}][name]" onchange="changeAttributeValues(event, {{ $loop->index }});" class="attribute-select form-control">
                               ...
                               <option value="{{ $attr->name }}" {{ $attr->name == $attributes->name ? 'selected' : '' }}>{{ $attr->name }}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select name="attributes[{{ $loop->index }}][value]" class="attribute-select form-control">
                                ...
                                @foreach(\App\Models\AttributeValue::all() as $value)
                                    <option value="{{ $value->name }}" {{ $value->name == $attributes->pivot->value->name ? 'selected' : '' }}>{{ $value->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
